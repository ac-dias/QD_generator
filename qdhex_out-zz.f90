program main
	...
	integer,parameter :: mmax=11 !tamanho do ponto quantico
	double precision :: modv

	character(*),parameter :: auxiliar='/home/adias/codigosalex/qdmx2/parametros-tmd/aux_mos2t.dat'

	character(*),parameter :: redem='rede_m_hex-zz.dat'
	character(*),parameter :: redex='rede_x_hex-zz.dat'
	character(*),parameter :: xyz='qdot_hex-zz.xyz'
