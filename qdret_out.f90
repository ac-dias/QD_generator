...
program main
	...
	integer,parameter :: mmaxx=10 !tamanho do ponto quantico 
	integer,parameter :: mmaxy=5 !tamanho do ponto quantico
	integer,parameter :: mmax=20 !tamanho do ponto quantico 
	...
	character(*),parameter :: redem='trede_m_ret.dat'
	character(*),parameter :: redex='trede_x_ret.dat'
	character(*),parameter :: xyz='tqdot_ret-ac.xyz'
