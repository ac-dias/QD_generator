program main
	...
	integer,parameter :: mmax=16 !tamanho do ponto quantico
	double precision :: modv

	character(*),parameter :: auxiliar='/home/adias/codigosalex/qdmx2/parametros-tmd/aux_mos2t.dat'

	character(*),parameter :: redem='rede_m_tri-zz.dat'
	character(*),parameter :: redex='rede_x_tri-zz.dat'
	character(*),parameter :: xyz='qdot_tri-zz.xyz'
