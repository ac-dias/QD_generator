...
program main
	...
	double precision :: mmaxx !tamanho do ponto quantico 
	double precision :: mmaxy !tamanho do ponto quantico
	integer,parameter :: mmax=200 !tamanho do ponto quantico 
	...
	write(*,*) "Quantum Size in x direction in Angstrom"
	read(*,*) mmaxx
	
	write(*,*) "Quantum Size in y direction in Angstrom"
	read(*,*) mmaxy		

	write(outfile,"(a7,I0,a1,I0,a4)") 'qd_rect',int(mmaxx),"_",int(mmaxy),".xyz"
	...
	call atomcount(a,mmaxx,mmaxy,natom)
	...
	do n=0,3000
		...
		do m=-n,mmax/2
			...
			r(2)=dble(2*m)*r1(2)+dble(n)*r2(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 100
...
100				continue								
			...
			r(2)=dble(2*m+1)*r1(2)+dble(n)*r2(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 200
	...
	do n=-1,3000
		...
		do m=-n-1,mmax/2
			...
			r(2)=dble(2*m)*r1(2)+dble(n)*r2(2)+rp(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 300
...
300				continue								
			...
			r(2)=dble(2*m+1)*r1(2)+dble(n)*r2(2)+rp(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 400
...
subroutine atomcount(a,mmaxx,mmaxy,natom)
	...
	do n=0,3000
		...
		do m=-n,mmax/2
			...
			r(2)=dble(2*m)*r1(2)+dble(n)*r2(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 101
...
101				continue								
			...
			r(2)=dble(2*m+1)*r1(2)+dble(n)*r2(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 201
	...
	do n=-1,3000
		...
		do m=-n-1,mmax/2
			...
			r(2)=dble(2*m)*r1(2)+dble(n)*r2(2)+rp(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 301
...
301				continue								
			...
			r(2)=dble(2*m+1)*r1(2)+dble(n)*r2(2)+rp(2)
				...
				if ( (r(2) .gt.(mmaxy*r2(2)+tol)) .or. (r(1) .gt.(a*mmaxx+tol)) .or. (r(1) .lt. 0d0 ) ) go to 401
