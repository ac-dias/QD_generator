program main
	...
	double precision,parameter :: rcut=25. !tamanho do ponto quantico
	...
	character(*),parameter :: redem='rede_m_r_25.dat'
	character(*),parameter :: redex='rede_x_r_25.dat'
	character(*),parameter :: xyz='qdot_r_25.xyz'
